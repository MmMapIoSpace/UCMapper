...
typedef NTSTATUS (*PsCreateSystemThread_t)(_Out_ PHANDLE ThreadHandle,
...
typedef PVOID (*MmMapLockedPagesSpecifyCache_t)(_Inout_ PVOID MemoryDescriptorList,
...
typedef void* (*memcpy_t)(_Out_writes_bytes_all_(_Size) void* _Dst, _In_reads_bytes_(_Size) const void* _Src, _In_ size_t _Size);
