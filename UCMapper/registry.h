...
RtlRegSetKeyValue32(_In_ LPCWSTR RegistryPath, _In_ LPCWSTR Valuename, ULONG Value)
{
    return RtlRegSetKeyValue(RegistryPath, Valuename, REG_DWORD, &Value, sizeof(ULONG));
}

FORCEINLINE NTSTATUS
RtlRegSetKeyValue64(_In_ LPCWSTR RegistryPath, _In_ LPCWSTR Valuename, ULONGLONG Value)
{
